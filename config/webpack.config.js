...
const config = {
  ...
  devServer: {
    ...
    hot: true,
    liveReload: false,
    // Required for testing on a real phone via ngrok (see README/mobile
    // testing instructions) - without this, webpack-dev-server rejects
    // requests coming through the ngrok tunnel with a "Blocked host" error.
